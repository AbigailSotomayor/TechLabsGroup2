        ...
        <svg width="126.795" height="129.387 ">
          <g data-name="Group 146" transform="translate(-64.456)">
            ...
            <circle
              ...
              cy="39.096"
              r="39.096"
              transform="translate(104.797 8.262)"
              opacity="0.05"
            ></circle>
            <circle
              ...
              cy="32.042"
              r="32.042"
              transform="translate(111.85 15.316)"
              opacity="0.05"
            ></circle>
            <circle
              ...
              cy="22.974"
              r="22.974"
              transform="translate(120.918 24.384)"
              opacity="0.05"
            ></circle>
            <path
              data-name="Path 630"
            ...
            <circle
              ...
              cy="5.797"
              r="5.797"
              transform="translate(77.365 28.042)"
              fill="#ffb8b8"
            ></circle>
            <path
              data-name="Path 635"
            ...
            <path
              data-name="Path 637"
              d="M90.407 76.832s2.62 8 .414 7.722-3.172-6.895-3.172-6.895z"
              fill="#ffb8b8"
            ></path>
            <path
              data-name="Path 638"
            ...
            <path
              data-name="Path 639"
              d="M80.271 65.182l6.343 11.308-5.343-11.918z"
              opacity="0.1"
            ></path>
            <path
              data-name="Path 640"
